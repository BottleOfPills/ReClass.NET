...
namespace ReClassNET.DataExchange.ReClass
{
	public partial class ReClassNetFile : IReClassImport, IReClassExport
	{
		...
		private static readonly Dictionary<string, Type> buildInStringToTypeMap = new[]
		{
			...
			typeof(DoubleNode),
			typeof(DoubleMatrix3x3Node),
			typeof(DoubleMatrix3x4Node),
			typeof(DoubleMatrix4x4Node),
			typeof(DoubleVector2Node),
			typeof(DoubleVector3Node),
			typeof(DoubleVector4Node),
			typeof(FloatNode),
			typeof(FunctionNode),
